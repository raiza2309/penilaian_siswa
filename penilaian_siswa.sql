...
--
-- Host: localhost:3306
-- Generation Time: Jun 21, 2022 at 08:19 PM
...
INSERT INTO `jawaban` (`id_soal`, `jawaban1`, `jawaban2`, `jawaban3`, `created_at`, `updated_at`) VALUES
(2, '0', '-2', '2', '2022-06-21 06:05:13', '2022-06-21 06:05:13'),
(3, '3', '-10', '5', '2022-06-21 06:06:42', '2022-06-21 06:06:42');
...
(12, '2022_06_21_125019_soal', 2),
(13, '2022_06_21_125031_jawaban', 2);
...
INSERT INTO `soal` (`id`, `soal`, `jawaban`, `created_at`, `updated_at`) VALUES
(2, '1 + 1 = ...', '2', '2022-06-21 06:05:13', '2022-06-21 06:05:13'),
(3, '10 - 20 = ...', '-10', '2022-06-21 06:06:42', '2022-06-21 06:06:42');
...
--
ALTER TABLE `jawaban`
  ADD CONSTRAINT `jawaban_id_soal_foreign` FOREIGN KEY (`id_soal`) REFERENCES `soal` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
